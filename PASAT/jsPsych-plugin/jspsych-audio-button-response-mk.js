...
jsPsych.plugins["audio-button-response-mk"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-audio-button-response-mk-btngroup" class="outerBlock">';
    for (var i = 0; i < trial.choices.length; i++) {
      var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
      if(i<6){
        var gridNum = i+1;
        html += '<div class="jspsych-audio-button-response-mk-button" style="grid-row: 1; grid-column:'+ gridNum +'; cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-mk-button-' + i +'" data-choice="'+i+'">'+str+'</div>';
      }else if(i>5 && i<12){
        var gridNum = (i+1)-6;
        html += '<div class="jspsych-audio-button-response-mk-button" style="grid-row: 2; grid-column:'+ gridNum +'; cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-mk-button-' + i +'" data-choice="'+i+'">'+str+'</div>';
      }else if(i>11){
        var gridNum = (i+1)-12;
        html += '<div class="jspsych-audio-button-response-mk-button" style="grid-row: 3; grid-column:'+ gridNum +'; cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-mk-button-' + i +'" data-choice="'+i+'">'+str+'</div>';
      }
      // html += '<div class="jspsych-audio-button-response-mk-button" style="cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-mk-button-' + i +'" data-choice="'+i+'">'+str+'</div>';
    }
    html += '</div>';
